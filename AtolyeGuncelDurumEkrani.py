...
# Form implementation generated from reading ui file 'AtolyeGuncelDurumEkrani.ui'
#
...
class Ui_atolyeGuncelDurum(object):
    def setupUi(self, atolyeGuncelDurum):
        atolyeGuncelDurum.setObjectName("atolyeGuncelDurum")
        atolyeGuncelDurum.resize(1419, 890)
        self.gridLayout = QtWidgets.QGridLayout(atolyeGuncelDurum)
        self.gridLayout.setObjectName("gridLayout")
        self.tabWidget = QtWidgets.QTabWidget(atolyeGuncelDurum)
        ...
        self.tableView_Atolyeler = QtWidgets.QTableView(self.tab)
        self.tableView_Atolyeler.setMinimumSize(QtCore.QSize(650, 0))
        self.tableView_Atolyeler.setMaximumSize(QtCore.QSize(650, 16777215))
        self.tableView_Atolyeler.setObjectName("tableView_Atolyeler")
        self.verticalLayout.addWidget(self.tableView_Atolyeler)
        ...
        self.retranslateUi(atolyeGuncelDurum)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(atolyeGuncelDurum)

    def retranslateUi(self, atolyeGuncelDurum):
        _translate = QtCore.QCoreApplication.translate
        atolyeGuncelDurum.setWindowTitle(_translate("atolyeGuncelDurum", "Atölye Genel Durum"))
        self.label.setText(_translate("atolyeGuncelDurum", "Güncel Bakiye:"))
        self.label_3.setText(_translate("atolyeGuncelDurum", "Son ürün satın alma tarihi:"))
        self.label_5.setText(_translate("atolyeGuncelDurum", "Son ödeme tarihi:"))
        self.label_7.setText(_translate("atolyeGuncelDurum", "Son iade tarihi:"))
        self.label_8.setText(_translate("atolyeGuncelDurum", "Son iade alınan ödeme tarihi:"))
        self.label_bakiye.setText(_translate("atolyeGuncelDurum", "-"))
        self.label_sonsatis.setText(_translate("atolyeGuncelDurum", "-"))
        self.label_sonodeme.setText(_translate("atolyeGuncelDurum", "-"))
        self.label_soniade.setText(_translate("atolyeGuncelDurum", "-"))
        self.label_soniadeodeme.setText(_translate("atolyeGuncelDurum", "-"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("atolyeGuncelDurum", "Atölye Güncel Durum"))
        self.radioButton_3.setText(_translate("atolyeGuncelDurum", "Tarihe Göre"))
        self.radioButton_2.setText(_translate("atolyeGuncelDurum", "İşleme Göre"))
        self.radioButton.setText(_translate("atolyeGuncelDurum", "Ürüne Göre"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("atolyeGuncelDurum", "Alışveriş Özeti"))
        self.label_2.setText(_translate("atolyeGuncelDurum", "Yıl:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("atolyeGuncelDurum", "İstatistik"))
